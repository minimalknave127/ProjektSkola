...
namespace BookKeeperBECommon.Repos
{
    ...
    public class ReceiptRepoMysql
    {
        ...
        public IList<Receipt> FindList(Receipt user)
        {
            using (var context = new MysqlContext())
            {
        ...
        public bool Exists(Receipt user)
        {
            using (var context = new MysqlContext())
            {
        ...
        public Receipt Load(Receipt user)
        {
            if (!Exists(user))
            {
        ...
        public void Store(Receipt user)
        {
            using (var context = new MysqlContext())
            {
        ...
        public void Remove(Receipt user)
        {
            using (var context = new MysqlContext())
            {
