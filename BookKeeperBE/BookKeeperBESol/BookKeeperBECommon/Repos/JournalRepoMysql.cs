...
namespace BookKeeperBECommon.Repos
{
    ...
    public class JournalRepoMysql
    {
        ...
        public IList<Journal> FindList(Journal user)
        {
            using (var context = new MysqlContext())
            {
        ...
        public bool Exists(Journal user)
        {
            using (var context = new MysqlContext())
            {
        ...
        public Journal Load(Journal user)
        {
            if (!Exists(user))
            {
        ...
        public void Store(Journal user)
        {
            using (var context = new MysqlContext())
            {
        ...
        public void Remove(Journal user)
        {
            using (var context = new MysqlContext())
            {
