    ...
    public class InvoiceItemRepoMysql
    {
        ...
        public IList<InvoiceItem> FindList(InvoiceItem user)
        {
            using (var context = new MysqlContext())
            {
                ...
                IQueryable<InvoiceItem> query = BuildQuery(context.Users, user);
        ...
        public bool Exists(InvoiceItem user)
        {
            using (var context = new MysqlContext())
            {
                ...
                IQueryable<Invoice> query = BuildQuery(context.Users, user);
        ...
        private IQueryable<InvoiceItem> BuildQuery(IQueryable<InvoiceItem> query, InvoiceItem user)
        {
